...
import { Archive, ArchiveX, Clock, Forward, Lock, MoreVertical, Pencil, Reply, ReplyAll, SendHorizonal, Trash2, Unlock } from "lucide-react"
...
export default function Topic({ topic, mapKey, selected }) {
          ...
          <section className="p-4">
            <form>
              <div className="flex items-stretch gap-4">
                <Textarea
                  className="p-2 min-h-[0px] h-2.25rem"
                  placeholder={`Reply ${topic.creation_author}...`}
                />
                  <Button
                    onClick={(e) => e.preventDefault()}
                    size="sm"
                    className="ml-auto flex h-full variant-ghost"
                  >
